...
// Default sample from Test Vectors (with safety checks)
const SAMPLE_LITE_TEXT = HLX_SPEC_JSON?.components?.A_formal_canonical_specification?.canonical_test_vectors?.text_lite || '{14:{@0:null}}';
