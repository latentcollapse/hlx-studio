...
const ErrorTaxonomy: React.FC = () => {
  const taxonomy = HLX_SPEC_JSON.components.A_formal_canonical_specification.error_taxonomy;
  const ranges = HLX_SPEC_JSON.components.A_formal_canonical_specification.canonical_format_rules.error_model_ranges;
