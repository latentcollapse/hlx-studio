...
Train Phase 1: Semantic Grounding (Epochs 6-30)
...
def parse_args():
    ...
    parser.add_argument("--resume", type=str, default="checkpoints/final_model.pt",
                        help="Path to checkpoint to resume from (default: checkpoints/final_model.pt)")
    parser.add_argument("--start-epoch", type=int, default=6,
                        help="Starting epoch number (default: 6 for Phase 1)")
    parser.add_argument("--phase", type=str, default="Phase 1: Semantic Grounding",
    ...
    parser.add_argument("--corpus-path", type=str,
                        default="corpus_combined_phase1.md",
                        help="Path to combined corpus (default: corpus_combined_phase1.md)")
    ...
    parser.add_argument("--save-history", type=str, default="training_history_phase1.json",
                        help="Path to save training history (default: training_history_phase1.json)")
    ...
    try:
        for epoch in range(args.epochs):
            ...
            if val_loss < trainer.best_val_loss:
                ...
                trainer.save_checkpoint(f"best_model_phase1_epoch{current_epoch}.pt")
        ...
        trainer.save_checkpoint("phase1_final_epoch30.pt")
        ...
        print("  - best_model_phase1_epoch*.pt (lowest validation loss)")
        print("  - checkpoint_epoch*.pt (every 5 epochs)")
        print("  - phase1_final_epoch30.pt (end of Phase 1)")
        print()
        ...
        trainer.save_checkpoint("phase1_interrupted.pt")
        print("✓ Checkpoint saved: phase1_interrupted.pt")
        print()
        sys.exit(1)
