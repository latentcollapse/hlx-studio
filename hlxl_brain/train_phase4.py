...
Train Phase 4: Perfect HLX + English (Epochs 81-105)

This script resumes from the Phase 2 checkpoint and trains on extended sequences
with long-form reasoning examples.

Usage:
    python3 train_phase4.py --epochs 25 --batch-size 32 --lr 1e-3 --seq-length 256
...
def parse_args():
    ...
    parser.add_argument("--start-epoch", type=int, default=81,
                        help="Starting epoch number (default: 56 for Phase 3)")
    parser.add_argument("--phase", type=str, default="Phase 4: Perfect HLX + English",
    ...
    parser.add_argument("--corpus-path", type=str,
                        ...
                        help="Path to combined corpus (default: corpus_combined_phase4.md)")
    ...
    parser.add_argument("--save-history", type=str, default="training_history_phase4.json",
                        help="Path to save training history (default: training_history_phase4.json)")
    ...
    try:
        for epoch in range(args.epochs):
            ...
            if val_loss < trainer.best_val_loss:
                ...
                trainer.save_checkpoint(f"best_model_phase4_epoch{current_epoch}.pt")
        ...
        trainer.save_checkpoint("phase4_final_epoch105.pt")
        ...
        print("  - best_model_phase4_epoch*.pt (lowest validation loss)")
        print("  - checkpoint_epoch*.pt (every 5 epochs)")
        print("  - phase4_final_epoch105.pt (end of Phase 3)")
        print()
        ...
        trainer.save_checkpoint("phase4_interrupted.pt")
        print("✓ Checkpoint saved: phase4_interrupted.pt")
        print()
        sys.exit(1)
