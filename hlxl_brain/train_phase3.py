#!/usr/bin/env python3
"""
HLXL Brain - Phase 3 Long-form Reasoning Training Script

Train Phase 3: Long-form Reasoning (Epochs 56-80)

This script resumes from the Phase 2 checkpoint and trains on extended sequences
with long-form reasoning examples.

Usage:
    python3 train_phase3.py --epochs 25 --batch-size 32 --lr 1e-3 --seq-length 256
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="HLXL Brain Phase 3 Training")

    # Phase-specific arguments
    parser.add_argument("--resume", type=str, default="checkpoints/phase2_final_epoch55.pt",
                        help="Path to checkpoint to resume from (default: checkpoints/phase2_final_epoch55.pt)")
    parser.add_argument("--start-epoch", type=int, default=56,
                        help="Starting epoch number (default: 56 for Phase 3)")
    parser.add_argument("--phase", type=str, default="Phase 3: Long-form Reasoning",
    ...
    parser.add_argument("--corpus-path", type=str,
                        default="corpus_combined_phase3.md",
                        help="Path to combined corpus (default: corpus_combined_phase3.md)")
    parser.add_argument("--seq-length", type=int, default=256,
                        help="Sequence length (default: 256 for Phase 3 long-form)")
    ...
    parser.add_argument("--save-history", type=str, default="training_history_phase3.json",
                        help="Path to save training history (default: training_history_phase3.json)")
    ...
    try:
        for epoch in range(args.epochs):
            ...
            if val_loss < trainer.best_val_loss:
                ...
                trainer.save_checkpoint(f"best_model_phase3_epoch{current_epoch}.pt")
        ...
        trainer.save_checkpoint("phase3_final_epoch80.pt")
        ...
        print("  - best_model_phase3_epoch*.pt (lowest validation loss)")
        print("  - checkpoint_epoch*.pt (every 5 epochs)")
        print("  - phase3_final_epoch80.pt (end of Phase 3)")
        print()

        print("="*80)
        print("SUCCESS - Phase 3 complete! Ready for Phase 4 or evaluation.")
        print("="*80)
        ...
        trainer.save_checkpoint("phase3_interrupted.pt")
        print("✓ Checkpoint saved: phase3_interrupted.pt")
        print()
        sys.exit(1)
