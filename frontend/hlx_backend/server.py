...
from hlx_backend.routes import runtime, observer, hlxl, claude_control, brain
...
async def startup_event():
    """Initialize brain corpus on application startup."""
    await brain.load_corpus_on_startup()
